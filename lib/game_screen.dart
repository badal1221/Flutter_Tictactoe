...
class _GamescreenState extends State<Gamescreen>{
  ...
  void _makemove(int row,int col){
    ...
    setState(() {
     ...
     _currentPlayer=(_currentPlayer=="X")?"O":"X";//player switching
  ...
  if(_winner!=""){
    ...
    _winner=="O"? widget.player2+" Won!":"It's a Tie",
     btnOkOnPress: (){
        _resetGame();
     },
      onDismissCallback: (DismissAction){
        _resetGame();
      },
    )..show();
  }
        ...
        child: Column(children: [
          ...
          child: Column(children: [
              Row(mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("Turn: ",style:TextStyle(fontSize: 24,
                  ...
                  Text(_currentPlayer=="X"?widget.player1+ " ($_currentPlayer)"
                    ...
                    fontWeight: FontWeight.bold,
                    color: _currentPlayer=="X"?Color(0xFFE25041):
                      Color(0xFF1CBD9E),
                    ),
                  ),
              ],),
